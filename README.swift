...
//  Swift_Aufgabe_Tag08
//
//  Created by Bernadette Werneke on 04.05.23.
//
/*
import Foundation
...
Hinweis: Nur der Code in der main Datei wird ausgeführt
...
Screenshot 2023-02-21 at 15 47 40
 
 
 Name des Users: Peter
 Alter des Users: 23
 Adresse: Musterstraße 1
 Email: peter.muster@mail.de
 UserID: 002
 Smartphone: Samsung Galxy $21
 Betriebssytem: Android
 Jahr: 2021
 Peter ist mit seinem Samsung Galxy S21 eingeloggt
 Schulfach der Lehrkraft: Informatik
 Anzahl der angelegten Schüler: 3
 Die Stadt heißt: Entenhausen
 Dieser Schüler heißst Marco und der ist 7 Jahre alt
*/
